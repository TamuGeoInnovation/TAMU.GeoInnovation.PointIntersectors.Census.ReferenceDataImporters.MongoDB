...
{
    public abstract class MongoDBImporterWorker : AbstractImporterWorker
    {
        #region Properties
        ...
        public MongoDBImporterWorker()
            : base() { }

        public MongoDBImporterWorker(TraceSource traceSource, BackgroundWorker backgroundWorker, IQueryManager queryManager, ISchemaManager schemaManager)
