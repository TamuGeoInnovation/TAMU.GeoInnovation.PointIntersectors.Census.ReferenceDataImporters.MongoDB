...
{
    public class MongoDBCensusTractLevelCountsUpdaterImporterWorker : AbstractCensusTractLevelCountsUpdaterImporterWorker
    {
        #region Properties

        #endregion

        public MongoDBCensusTractLevelCountsUpdaterImporterWorker() : base() { }

        public MongoDBCensusTractLevelCountsUpdaterImporterWorker(TraceSource traceSource, BackgroundWorker backgroundWorker, IQueryManager outputDataQueryManager, ISchemaManager schemaManager) : base(traceSource, backgroundWorker, outputDataQueryManager, schemaManager) { }
