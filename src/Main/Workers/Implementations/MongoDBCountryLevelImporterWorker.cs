...
{
    public class MongoDBCountryLevelImporterWorker : AbstractCountryLevelImporterWorker
    {
        #region Properties

        #endregion

        public MongoDBCountryLevelImporterWorker() : base() { }

        public MongoDBCountryLevelImporterWorker(TraceSource traceSource, BackgroundWorker backgroundWorker, IQueryManager outputDataQueryManager, ISchemaManager schemaManager)
