...
{
    public class MongoDBStateLevelImporterWorker : AbstractStateLevelImporterWorker
    {
        #region Properties

        #endregion

        public MongoDBStateLevelImporterWorker() : base() { }

        public MongoDBStateLevelImporterWorker(TraceSource traceSource, BackgroundWorker backgroundWorker, IQueryManager outputDataQueryManager, ISchemaManager schemaManager)
