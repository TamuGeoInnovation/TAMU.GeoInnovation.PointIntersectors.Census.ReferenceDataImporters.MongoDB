...
{
    public class MongoDBCensusTractLevelIndexUpdaterImporterWorker : AbstractCensusTractLevelIndexUpdaterImporterWorker
    {
        #region Properties

        #endregion

        public MongoDBCensusTractLevelIndexUpdaterImporterWorker() : base() { }

        public MongoDBCensusTractLevelIndexUpdaterImporterWorker(TraceSource traceSource, BackgroundWorker backgroundWorker, IQueryManager outputDataQueryManager, ISchemaManager schemaManager) : base(traceSource, backgroundWorker, outputDataQueryManager, schemaManager) { }
